...
class DeepLearningData:
    ...
    def get_state(self):
        ...
        # state = np.concatenate((positions_x, positions_y, velocity_x, velocity_y, speeds, collisions, vectors), axis=0)
        state = np.concatenate((positions_x, positions_y, velocity_x, velocity_y, speeds, collisions), axis=0)
